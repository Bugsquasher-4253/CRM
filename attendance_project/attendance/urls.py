...
urlpatterns = [
    ...
    path("attendance/pause/", views.pause_attendance, name="pause_attendance"),
    path("attendance/resume/", views.resume_attendance, name="resume_attendance"),
    ...
    path("employees/<int:emp_id>/rehire/", views.rehire_employee, name="rehire_employee"),
    ...
    path(
        "admin-panel/attendance/<int:record_id>/delete/",
